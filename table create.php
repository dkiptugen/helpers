...
<div class="col-sm-4">
<form action="<?php $_SERVER['PHP_SELF'];  ?>" method="post" class="form form-horizontal" role="form ">
...
if(isset($_POST["xx"]))
{
  $name="TABLES/".$_POST['file-name'].'.php';
  $handle=fopen($name,'a');
  chmod($name, 0775);
  #print_r($_POST["val"]);
...
?>
<form action="<?php $_SERVER['PHP_SELF'];  ?>" method="post" class="form form-horizontal" role="form" enctype="multipart/form_data">
